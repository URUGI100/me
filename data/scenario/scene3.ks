...
[playbgm  volume="70"  time="2000"  loop="true"  storage="stormy-seas.mp3"  fadein="true"  ]
[mask_off  time="2000"  effect="fadeOut"  ]
[tb_start_text mode=2 ]
평소보다 일찍 눈을 떴다.[l][r]
자기 전 알람을 당겨둔 덕분이다. 어제처럼 급했던 출근준비로 하루를 시작하고 싶진 않았다.[l][r]
오늘 역시 문을 열자마자 예약이 들어 있다.[l][r]
사토씨라면 아마 어제처럼 정각에 도착하겠지.[l][r]
[r]길게 하품하며 시각을 확인했다.[l][r]
오전 여섯시 삼십분. 출근 준비에도 영업 준비에도 충분한 여유가 있다.[l][r]
욕실로 향해 칫솔을 입에 물었다. [l][r]
[_tb_end_text]

[chara_mod  name="레이겐"  time="600"  cross="true"  storage="chara/1/reigen-suit-nomal.png"  ]
[tb_start_text mode=1 ]
[r]씻기를 끝마친 나는 구두 뒤축에 발을 집어넣으며 현관을 나섰다.[p]
[_tb_end_text]

[chara_hide  name="레이겐"  time="1000"  wait="false"  pos_mode="false"  ]
[bg  time="1000"  method="fadeIn"  storage="street.png"  cross="false"  ]
[bg  time="1000"  method="fadeIn"  storage="office-out.png"  cross="false"  ]
...
[tb_start_text mode=2 ]
한산한 출근길을 지나 도착한 상담소.[l][r]
아직 출근시간 전인 세리자와도 와 있지 않다.[l][r]
어젯밤 퇴근 전 정리했던 실내를 다시 한 번 둘러보지만 딱히 다시 손볼 구석은 없어 보인다.[l][r]
[r]자리를 정리하고 오늘 치 예약 장부를 확인했다.[l][r]
아홉 시에 사토씨가 적혀 있고 오후에는 출장 요청으로 외근이 한 건 있다. 외의 예정된 일은 없다.[l][r]
환절기답지 않은 허전한 예약 장부다.[l][r]
[_tb_end_text]

[tb_start_text mode=1 ]
예약 없이 찾아드는 손님이 있으려나, 생각하며 사토씨와의 상담 내역을 추가로 적고 있을 때였다.[p]
[_tb_end_text]

[chara_hide  name="레이겐"  time="500"  wait="false"  pos_mode="false"  ]
[stopbgm  time="2000"  fadeout="true"  ]
[chara_show  name="세리자와"  time="500"  wait="true"  storage="chara/3/seri-nomal.png"  width="540"  height="1124"  left="690"  top="70"  ]
[tb_start_text mode=2 ]
#세리자와
“안녕하세요, 레이겐씨.”[l][r]
[_tb_end_text]
...
[tb_start_text mode=2 ]
세리자와가 출근했다. [l][r]
벽시계를 바라보자 현재 시각 여덟시 삼십분.[l][r]
유일한 종업원마저 출근했으니 영업 준비는 모두 마쳤다고 볼 수 있다.[l][r]
[_tb_end_text]

[tb_start_text mode=2 ]
#레이겐
[r]“시간 좀 있는데 커피 한 잔 마실까?”[l][r]
[_tb_end_text]
...
[chara_hide  name="세리자와"  time="500"  wait="true"  pos_mode="true"  ]
[tb_start_text mode=2 ]
나는 주방으로 향하는 세리자와에게 “땡큐.” 인사하고는 다시 시선을 내렸다.[l][r]
책상 위에 놓인 예약 장부, 그리고 그 아랫칸의 특이사항 메모를 확인하기 위해서.[l][r]
[_tb_end_text]
...
[tb_image_show  time="1000"  storage="default/item/sato2.png"  width="520"  height="190"  x="70"  y="310"  name="img_31"  ]
[l  ]
[tb_start_text mode=1 ]
[r][r][r][r][r][r][r]짧은 내용을 확인하는 동안 주방에서 커피포트 물 끓는 소리가 났다.[p]
[_tb_end_text]

[tb_image_hide  time="0"  ]
[chara_show  name="레이겐"  time="1000"  wait="false"  storage="chara/1/reigen-suit-nomal.png"  width="540"  height="1124"  left="520"  top="70"  ]
[chara_show  name="세리자와"  time="1000"  wait="true"  storage="chara/3/seri-nomal.png"  width="540"  height="1124"  left="860"  top="80"  ]
[tb_start_text mode=2 ]
#세리자와
“찬물 약간 섞은 게 이쪽이에요.”[l][r]
[_tb_end_text]
...
[tb_start_text mode=2 ]
배려 덕분에 커피는 딱 마시기 좋은 온도였다.[l][r]
나는 잔을 몇 번 홀짝이고는 책상에 내려놓았다.[l][r]
[_tb_end_text]

[tb_start_text mode=2 ]
#레이겐
[r]“어제 아침 의뢰인이 이제 다시 올 거야.”[l][r]
[_tb_end_text]

[tb_start_text mode=2 ]
#세리자와
“기억해요. 사토씨였죠. 본명은 아닐 거라던.”[l][r]
[_tb_end_text]

[tb_start_text mode=2 ]
#레이겐
“그래. 어제는 어땠어? 학교에서 만났어?”[l][r]
[_tb_end_text]
...
[chara_mod  name="레이겐"  time="600"  cross="true"  storage="chara/1/reigen-suit-smile.png"  ]
...
[chara_mod  name="세리자와"  time="600"  cross="false"  storage="chara/3/seri-dis.png"  ]
[tb_start_text mode=2 ]
#세리자와
“아, 아뇨. 아무 이유도 없이 그런 짓을…,”[l][r]
[_tb_end_text]

[tb_start_text mode=2 ]
#레이겐
“없기는. 이유라면 이제 있잖아?”[r][l][r]
[_tb_end_text]

[tb_start_text mode=2 ]
쩔쩔맬 소리도 아닌 말에 한참 말을 고른다.[l][r]
세리자와의 태도를 보고서야 나는 내 직감을 확신했다. [l]분명… 이건 어떤 종류의 기류다.[l][r]
[_tb_end_text]

[tb_start_text mode=1 ]
[r]흔히 ‘썸’이라고 부르는, 핑크빛의 무언가.[p]
[_tb_end_text]

[tb_start_text mode=2 ]
이제야 서막을 쓸까 말까 하는 남의 연애사라면 재밌지 않을 리가 없다.[l][r]
히죽이며 한 번 더, 세리자와를 떠보았다.[l][r]
#레이겐
[r]“한 번 ‘사토씨’라고 불러나 봐. 실은 그 이름 아니라고, 진짜 이름 가르쳐주면서 다른 말이라도 하게 될 지 누가 알아?”[l][r]
#세리자와
“아, 그러고보니 그 말씀 말인데요.” [r][l][r]
[_tb_end_text]

[tb_start_text mode=1 ]
순간 화제를 포착할 기회를 노렸다는 듯, 세리자와가 다르게 말을 받았다.[p]
[_tb_end_text]

[chara_mod  name="세리자와"  time="300"  cross="false"  storage="chara/3/seri-nomal.png"  ]
[tb_start_text mode=2 ]
#세리자와
“레이겐씨 말처럼 ‘사토씨’는 사토가 아닌가 보더라고요. 어떻게 아셨어요?”[l][r]
#레이겐
“뭐, 그거야 이런 장사 하다보면 뻔하지. 그나저나 재밌는 소리네, 세리자와.”[r][l][r]
하지만 그래 봤자다. [l][r]
나는 집요하게 말머리를 다시 틀었다.[r][l][r]
[_tb_end_text]

[tb_start_text mode=1 ]
#레이겐
“너나 어떻게 알게 된 거야? ‘사토씨’가 사토가 아니라는 사실은?”[p]
[_tb_end_text]

[tb_start_text mode=2 ]
#세리자와
“그거야 학교 홈페이지에 적혀 있는 교직원 명부…, 앗, 생각하시는 그런 이유가 아니에요!”[r][l][r]
[_tb_end_text]

[chara_mod  name="세리자와"  time="300"  cross="false"  storage="chara/3/seri-dis.png"  ]
[tb_start_text mode=2 ]
교직원 명부는 나야말로 생각치 못했다.[l][r]
아니, 생각하더라도 굳이 고객의 실명을 캘 이유는 없지만. [l][r]
아무래도 세리자와의 태도는 그 새콤달콤한 무언가의 기류라는 내 확신만이 더해질 뿐이어서, 나는 소리내 웃고 말았다.[l][r]
[_tb_end_text]

[tb_start_text mode=1 ]
#레이겐
[r]“관심, 없다더니, 아하핫! 누구보다 사토씨에게 관심 많았잖아? 감이란 말이야, 경험의 총합이란 말이지. 처음부터 어쩐지 답지않은 태도더라니.”[p]
[_tb_end_text]

[tb_start_text mode=2 ]
한바탕 웃고 나자 세리자와가 허둥지둥 변명했다.[l][r]
#세리자와
[r]“그저 레이겐씨가 한 말을 듣고 진짠지 궁금했을 뿐이에요. 확인하고는 ‘역시 대단하다’ 생각했을 뿐 사토씨가 궁금해서는…,”[l][r]
#레이겐
“아부로 말 돌리려는 거야? 이제보면 사회생활은 더는 가르칠 게 없단 말야.”[r][l][r]
더 놀렸다가는 괜히 반발만 사겠다.[l][r]
오전 중 잡담으로는 꽤 재미있는 주제였다.[l][r]
나는 어느덧 아홉 시에 가까워진 벽시계를 흘긋 눈짓했다.[l][r]
[_tb_end_text]

[tb_start_text mode=1 ]
한숨 쉰 세리자와가 입을 다물었다.[p]
[_tb_end_text]
...
“이쯤이면… 노쇼네.”[r][l][r]
노쇼라. [l][r]
이 또한 수상한 장사 중에선 흔한 일이다. [l][r]
나는 예약금도 받지 않고 신원확인조차 하지 않는다. 이런 상담이 어떤 약속까진 될 필요는 없다는, 순전히 개인적인 지론 탓이다.[l][r]
오지 않으면 않는대로 좋다. 무소식이 희소식이란 말이 이처럼 잘 어울리는 일도 없지.[l][r]
[_tb_end_text]

[tb_start_text mode=1 ]
마사지와 숙면으로 컨디션이 나아진 거라면, 그래서 오늘은 이곳을 찾고 싶지 않게 된 까닭이라면 무엇보다 사토씨에게 좋은 일이다.[p]
[_tb_end_text]

[chara_hide  name="레이겐"  time="1000"  wait="false"  pos_mode="false"  ]
[bg  time="1000"  method="fadeIn"  storage="office-out.png"  ]
[tb_start_text mode=2 ]
한가한 김에 세리자와와 나가 점심을 먹었다.[l][r]
예약 장부에는 오후에도 세시에 외근 한 건 뿐이다. 오전 중 찾아온 손님도 달리 없다.[l][r]
#세리자와
[r]“요즘 들어 오랜만에 한가하네요.”[r][l][r]
덮밥을 우물대며 나는 세리자와의 말에 긍정했다. [l][r]
요 며칠 바빴으니 이런 날도 나쁘지 않다.[l][r]
모처럼 점심 때에 먹은 점심이다.[l][r]
어딜가나 번잡한 대로변 정경이 오랜만일 만큼. [l][r]
[_tb_end_text]

[tb_start_text mode=1 ]
[r]나와 세리자와는 사무소로 돌아왔다.[p]
[_tb_end_text]
...
[wait  time="2000"  ]
[tb_start_text mode=2 ]
상담소로 향하는 계단참을 오르던 때였다.[l][r]
문 앞에 이미 서 있는 왜소한 인영.[l][r]
[_tb_end_text]

[playbgm  volume="30"  time="2000"  loop="true"  storage="tea-ceremony.mp3"  fadein="true"  ]
[bg  time="1000"  method="crossfade"  storage="offic-door.png"  ]
[chara_show  name="손님"  time="1000"  wait="true"  storage="chara/2/client-dis.png"  width="540"  height="1124"  left="690"  top="80"  ]
[tb_start_text mode=2 ]
#손님
[r]“아, 소장님. 그리고… 그쪽은… 세리자와씨.”[r][l][r]
아침에 오지 않은 사토씨였다.[l][r]
#손님
[r]“죄송합니다. 예정한 시각보다 많이 늦어서.”[l][r]
#레이겐
“사토씨? 괜찮습니다. 안으로 들어오세요.”[r][l][r]
세리자와가 문간판을 뒤집어 ‘외출 중’을 ‘영업 중’으로 되바꾸었다. [l][r]
[_tb_end_text]

[tb_start_text mode=1 ]
나는 서둘러 열쇠를 꺼내 출입문 잠금을 열었다.[p]
[_tb_end_text]

[chara_move  name="손님"  anim="true"  time="500"  effect="linear"  wait="false"  left="840"  top="80"  width="540"  height="1124"  ]
[chara_show  name="레이겐"  time="1000"  wait="false"  storage="chara/1/reigen-suit-discon.png"  width="540"  height="1124"  left="550"  top="80"  ]
[playse  volume="100"  time="1000"  buf="1"  storage="door_key.mp3"  ]
[wait  time="1000"  ]
[bg  time="1000"  method="fadeIn"  storage="office-in.png"  ]
[tb_start_text mode=2 ]
#레이겐
“안 오셔서 오히려 안심했었는데. 혹시 무슨 일이라도?”[l][r]
#손님
“그런 건 아니에요. 오히려….”[r][l][r]

[_tb_end_text]

[chara_mod  name="손님"  time="600"  cross="true"  storage="chara/2/client-deep.png"  ]
[tb_start_text mode=2 ]
흐린 말끝과 달리 사토씨는 드물게 웃어보였다.[l][r]
아니, 드물다기보단… 처음 보는 미소였다.[l][r]
#손님
[r]“이제 괜찮다는 말씀을 드리려고요.”[l][r]
#레이겐
“그렇다면 다행이지만….”[l][r]
#손님
“괜한 걱정 끼쳐 죄송합니다. 지금은 괜찮아요.”[r][l][r]
[_tb_end_text]

[tb_start_text mode=1 ]
여전한 미소를 띈 사토씨가 한 마디를 더했다.[p]
[_tb_end_text]

[tb_start_text mode=2 ]
#손님
“그러니 이젠, 제 개인정보를 파기해 주세요.”[l][r]
#레이겐
“네, 물론이죠.”[l][r]
#손님
“그 말씀을 드리려고 왔어요.”[r][l][r]
개인정보라. 추측이지만 이름도 전화번호도 아마 이미 전부 가짜다. 그럼에도 파기할 정보라면.[l][r]
…‘상담 내역’ 정도겠지.[l][r]
다니는 학교의 교직원이더라는 세리자와의 말을 떠올리면 납득은 간다. 퍽이나 보수적인 직종이고.[l][r]
[_tb_end_text]

[chara_mod  name="레이겐"  time="300"  cross="false"  storage="chara/1/reigen-suit-business.png"  ]
[tb_start_text mode=1 ]
#레이겐
[r]“걱정마세요. 수기로만 작성하는 모든 고객정보는 상담 이후 파기하고 있습니다.”[p]
[_tb_end_text]

[jump  storage="scene3.ks"  target="*returnYumju"  cond="f.item_yumju==1"  ]
[jump  storage="scene3.ks"  target="*byeSato"  ]
*returnYumju

[tb_start_text mode=2 ]
고개를 끄덕인 사토씨가 어깨에서 가방을 내려 안을 뒤적였다.[l][r]
그 손끝에서 걸려 나온 것은,[l][r]
[_tb_end_text]
...
[tb_image_show  time="1000"  storage="default/item/yumju.png"  width="366"  height="130"  x="70"  y="270"  name="img_104"  ]
[l  ]
[tb_start_text mode=1 ]
